...
#define PACKAGE_BUGREPORT "simplicity2018@outlook.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Simplicity"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Simplicity 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "simplicity"
