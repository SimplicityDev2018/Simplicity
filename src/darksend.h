...
#define POOL_MAX_TRANSACTIONS_TESTNET          3 // wait for X transactions to merge and publish
...
{
public:
    /// Is the inputs associated with this public key? (and there is 200000 SPL - checking if valid masternode)
